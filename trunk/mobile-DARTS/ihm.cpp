    ...
    ui(new Ui::Ihm)
{
    ...
    ui->Donnees->setVisible(false);
    ui->meteo->setVisible(false);
    ui->commande->setVisible(false);
...
void Ihm::on_EnvoyerImpact_clicked()
{
    transmission->envoyerDonnees("$DART;GAME;" + ui->typePoint->text() + ";" + ui->nbPoint->text() +"\r\n");
}


void Ihm::on_TrameAleatoire_clicked()
{
    int nbPoint =0;
    int typePoint = 0;

    nbPoint = (rand() % (21 - 0 + 1)) + 0;
    typePoint = (rand() % (3 - 1 + 1)) + 1;
    ...
    transmission->envoyerDonnees("$DART;GAME;" + QString::number(typePoint) + ";" + QString::number(nbPoint) +"\r\n");
}

void Ihm::on_demarrerPartie_clicked()
{
    QString typeJeu = "";
    if(ui->typedeJeu->text() == "2")
    {
        typeJeu = "_DOUBLE_OUT";
    }
    else {
...
{
    transmission->envoyerDonnees("$DART;STOP\r\n");
}


void Ihm::on_PLAY_clicked()
{
    transmission->envoyerDonnees("$DART;PLAY\r\n");
}

void Ihm::on_PAUSE_clicked()
{
    transmission->envoyerDonnees("$DART;PAUSE\r\n");
}

void Ihm::on_pushButton_clicked()
{
    transmission->envoyerDonnees("$DART;RESET\r\n");
}

void Ihm::on_boutonRegle_clicked()
{
